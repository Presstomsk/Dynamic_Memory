...
int main()
{
	...
	cout << endl;
	arr_2 = insert_row(arr_2, m, n, m);
	Print(arr_2, m, n);
	cout << endl;
	cout << "Добавление строки в начало ДДМ: " << endl;
	cout << endl;
	arr_2 = insert_row(arr_2, m, n, 0);
	Print(arr_2, m, n);
	cout << endl;
	...
	cout << endl;
	arr_2 = erase_row(arr_2, m, n, m-1);
	Print(arr_2, m, n);
	cout << endl;
	cout << "Удаление строки в начале ДДМ: " << endl;
	cout << endl;
	arr_2 = erase_row(arr_2, m, n, 0);
	Print(arr_2, m, n);
	cout << endl;
	...
	cout << endl;
	arr_2 = insert_col(arr_2, m, n, n);
	Print(arr_2, m, n);
	cout << endl;
	cout << "Добавление столбца в начало ДДМ: " << endl;
	cout << endl;
	arr_2 = insert_col(arr_2, m, n, 0);
	Print(arr_2, m, n);
	cout << endl;
	...
	cout << endl;
	arr_2 = erase_col(arr_2, m, n, n-1);
	Print(arr_2, m, n);
	cout << endl;
	cout << "Удаление столбца в начале ДДМ: " << endl;
	cout << endl;
	arr_2 = erase_col(arr_2, m, n, 0);
	Print(arr_2, m, n);
	cout << endl;
...
template <typename T> T** insert_col(T** arr, const int m, int& n, const int index)
{
	T** buffer = Allocate <T>(m, ++n);
	for (int i = 0; i < m; i++)
	{
...
template <typename T> T** erase_col(T** arr, const int m, int& n, const int index)
{
	T** buffer = Allocate <T>(m, --n);
	for (int i = 0; i < m; i++)
	{
